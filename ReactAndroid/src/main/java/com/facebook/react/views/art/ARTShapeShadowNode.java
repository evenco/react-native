...
public class ARTShapeShadowNode extends ARTVirtualNode {
  ...
  // <Even> // backported from https://github.com/facebook/react-native/pull/5729
   ...
   */
  private static int parseGradientStops(float[] value, int stopsCount, float[] stops, int[] stopsColors) {
    ...
    if (mFillColor != null && mFillColor.length > 0) {
      ...
      switch (colorType) {
        ...
        case 1:
          ...
          parseGradientStops(mFillColor, stopsCount, stops, stopsColors);
          paint.setShader(
            new LinearGradient(
              mFillColor[1] * mScale,
              mFillColor[2] * mScale,
