...
<<<<<<< HEAD
  public static WeakHashMap<View, Integer> mZIndexHash = new WeakHashMap<>(); // <Even />
=======
...
>>>>>>> upstream/0.36-stable
  ...
  /**
   * <Even>
   * Returns whether the ViewGroup is responsible for calling
   * {@code layout()} on itself based on its props.
   * </Even>
   */
  public boolean needsCustomLayout() {
    return false;
  }
